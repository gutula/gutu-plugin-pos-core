...
const nestedRoot = join(repoRoot, "framework/builtin-plugins/pos-core");
...
if (failures.length > 0) {
  console.error("Documentation check failed for gutu-plugin-pos-core:");
...
console.log("Documentation check passed for gutu-plugin-pos-core.");
