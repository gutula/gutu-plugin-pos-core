...
export async function BusinessAdminPage() {
  ...
  return React.createElement(
    "section",
    null,
    React.createElement("h1", null, "POS Control Room"),
    React.createElement("p", null, "Store sessions, receipt journals, cashier shift posture, and offline reconciliation visibility."),
    React.createElement(
      "p",
      null,
